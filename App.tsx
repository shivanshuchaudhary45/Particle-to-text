    ...
    <div className="relative w-full h-screen bg-black">
      ...
      <div className="absolute inset-0 z-10 pointer-events-none flex flex-col justify-between p-6">
        ...
        <div className="w-full max-w-lg mx-auto pointer-events-auto pb-4 sm:pb-8">
           <div className="glass-panel p-2 rounded-2xl bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl shadow-cyan-900/20 flex gap-2 items-center transition-all focus-within:border-white/30 focus-within:shadow-cyan-900/40">
             <input
               type="text"
               value={inputValue}
